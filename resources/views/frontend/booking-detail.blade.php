        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            @if($booking->booking_status === 'pending')
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <a href="https://wa.me/6285934910789?text={{ $whatsappMessage }}" target="_blank" class="inline-flex items-center space-x-2 bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600 transition">
