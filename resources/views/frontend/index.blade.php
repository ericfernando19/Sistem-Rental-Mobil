            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg lg:text-xl text-blue-200 mb-8">
                        Nikmati kemudahan sewa mobil dengan armada lengkap, harga terjangkau, dan pelayanan terbaik. Siap
                        menemani perjalanan bisnis maupun liburan Anda.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('catalog') }}"
                            class="bg-yellow-400 text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition transform hover:scale-105">
                            Lihat Katalog Mobil
                        </a>
                        <a href="#layanan"
                ...
                <div class="hidden lg:flex items-center justify-center relative">
                    <div class="relative z-10">
                        <img src="{{ asset('rencar.png') }}" alt="Rencar" class="h-114 w-auto">
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition group">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('detail', $car) }}"
                                    class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition">Detail</a>
                            </div>
                        </div>
                    </div>
                @empty
            ...
            @if ($cars->count() > 0)
                <div class="text-center mt-8">
                    <a href="{{ route('catalog') }}"
                        class="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">Lihat
                        Semua Mobil</a>
                </div>
            @endif
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-8 rounded-xl hover:bg-gray-50 transition">
                    ...
                    <p class="text-gray-500">Armada terawat dengan asuransi komprehensif untuk kenyamanan perjalanan Anda.
                    </p>
                </div>
                <div class="text-center p-8 rounded-xl hover:bg-gray-50 transition">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">"Pelayanan sangat memuaskan! Mobil bersih, proses cepat, dan harga
                        terjangkau. Pasti akan sewa lagi di sini."</p>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">"Mobil yang disediakan berkualitas dan terawat. Pelayanan sopir juga
                        ramah dan profesional. Sangat recommended!"</p>
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-10 h-10 bg-green-200 rounded-full flex items-center justify-center text-green-600 font-bold">
                            S</div>
                        <div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">"Proses booking mudah dan cepat. Harga transparan tanpa biaya
                        tersembunyi. Layanan pelanggan sangat responsif."</p>
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-10 h-10 bg-purple-200 rounded-full flex items-center justify-center text-purple-600 font-bold">
                            B</div>
                        <div>
            ...
            <div class="space-y-4" x-data="{ active: null }">
                <div class="border border-gray-200 rounded-lg overflow-hidden" :class="{ 'shadow-md': active === 1 }">
                    <button @click="active = active === 1 ? null : 1"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition" :class="{ 'rotate-180': active === 1 }"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="active === 1" x-collapse class="p-4 text-gray-600 border-t border-gray-200">
                        Anda dapat booking mobil melalui website dengan memilih mobil yang diinginkan, mengisi form booking,
                        dan melakukan konfirmasi. Setelah itu, tim kami akan menghubungi Anda untuk verifikasi.
                    </div>
                </div>
                <div class="border border-gray-200 rounded-lg overflow-hidden" :class="{ 'shadow-md': active === 2 }">
                    <button @click="active = active === 2 ? null : 2"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition" :class="{ 'rotate-180': active === 2 }"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="active === 2" x-collapse class="p-4 text-gray-600 border-t border-gray-200">
                        Persyaratan utama: KTP asli, SIM A/B1 yang masih berlaku, dan jaminan (deposit atau BPKB) sesuai
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden" :class="{ 'shadow-md': active === 3 }">
                    <button @click="active = active === 3 ? null : 3"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition" :class="{ 'rotate-180': active === 3 }"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="active === 3" x-collapse class="p-4 text-gray-600 border-t border-gray-200">
                        Ya, kami menyediakan layanan antar jemput mobil ke lokasi Anda. Anda dapat memilih opsi ini saat
                        melakukan booking.
                    </div>
                </div>
                <div class="border border-gray-200 rounded-lg overflow-hidden" :class="{ 'shadow-md': active === 4 }">
                    <button @click="active = active === 4 ? null : 4"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition" :class="{ 'rotate-180': active === 4 }"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="active === 4" x-collapse class="p-4 text-gray-600 border-t border-gray-200">
                        Setiap mobil sudah dilengkapi asuransi komprehensif. Jika terjadi kecelakaan, segera hubungi tim
                        kami untuk bantuan dan proses klaim asuransi.
                    </div>
                </div>
                <div class="border border-gray-200 rounded-lg overflow-hidden" :class="{ 'shadow-md': active === 5 }">
                    <button @click="active = active === 5 ? null : 5"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition" :class="{ 'rotate-180': active === 5 }"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="active === 5" x-collapse class="p-4 text-gray-600 border-t border-gray-200">
                        Pembatalan dapat dilakukan dengan menghubungi tim kami. Kebijakan pembatalan dan refund mengikuti
