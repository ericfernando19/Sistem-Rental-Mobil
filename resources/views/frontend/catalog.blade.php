        ...
        <div class="bg-white p-6 rounded-xl shadow-md -mt-12 relative z-10 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                    ...
                    <input type="text" x-model="filters.search" @input.debounce.300ms="fetchResults()" placeholder="Nama atau merk mobil..." class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Transmisi</label>
                    <select x-model="filters.transmission" @change="fetchResults()" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <select x-model="filters.capacity" @change="fetchResults()" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        <option value="">Semua</option>
                ...
                <div>
                    ...
                    <select x-model="filters.min_price" @change="fetchResults()" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <select x-model="filters.max_price" @change="fetchResults()" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <script>
        function catalogFilter() {
            return {
                ...
                resetFilters() {
                    this.filters = { search: '', transmission: '', capacity: '', min_price: '', max_price: '' };
                    this.fetchResults();
                }
            }
        }
