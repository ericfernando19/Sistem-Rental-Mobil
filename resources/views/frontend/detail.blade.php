            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-md p-6 sticky top-24">
                    ...
                    @if($car->status === 'available')
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo, saya tertarik dengan {{ urlencode($car->name) }}" target="_blank" class="block w-full bg-green-500 text-white text-center py-3 rounded-lg font-semibold hover:bg-green-600 transition mt-3">
